    ...
    <section>
      <div class="big-div">
        <div class="big-img">
          <img
            alt="image"
            src="../Assets/Images/Hair_coloring-2.jpg"
            class="big-img-1"
          />
        </div>
        <div class="two-img">
          <div class="font-1">
            <div class="small-pic">
              <img
                alt="image"
                src="../Assets/Images/Hair_coloring-1.jpg"
                class="small-pic-1"
              />
            </div>
          ...
          <div class="font-1">
            <div class="small-pic">
              <img
                alt="image"
                src="../Assets/Images/Hair_coloring-4.jpg"
                class="small-pic-1"
              />
            </div>
            <div class="small-font">
       ...
       <div class="haircut_card">
          ...
          <div class="haircut_card-content">
            ...
            <p class="haircut_card-text"><%= style1.getHaircutAbout() %></p>
             <a href="salonlist" class="haircut_delete">Select</a>
          </div>
        </div>
