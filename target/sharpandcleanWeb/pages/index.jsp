...
<body>
	...
	<section class="hero_page">
		...
		<div class="service-font">
			<div class="service">
				<p class="service-font-1">We will provide the best haircut
					Service</p>
			</div>
		</div>
	</section>
	...
	<section>
		<div class="about_us">
			<div class="about_info">
				...
				<div>
					<p>Welcome to Sharp & Clean, where exceptional grooming meets
						unparalleled style. We are a dedicated team of skilled barbers
						committed to providing you with the finest grooming experience in
						Thoothukudi -08. Step into our barbershop, and allow us to take
						care of all your grooming needs with precision, passion, and a
						touch of old-fashioned charm. At Sharp & Clean, we believe that a
						great haircut is more than just a trim; it's an art form. Our team
						of experienced barbers brings years of expertise and a deep
						understanding of men's hairstyles and grooming trends. With their
						attention to detail and mastery of classic and contemporary
						cutting techniques, they will help you discover a look that
						perfectly complements your individual style and personality.</p>
				</div>
			</div>
			<div class="heroimgdiv">
				<img class="heroimg" src="../Assets/Images/about hero.jpg" alt="haircut" />
			</div>
		</div>
	</section>
	<section>
		<div class="online_booking">
			<div>
				<img src="../Assets/Images/book section.png" class="bookimg" alt="haircut" />
			</div>
			<div class="book">
				<h2>Welcome to the Sharp & Clean</h2>
				<p>Welcome to our sharp & clean, where grooming meets style and
	...
	<section class="shop_sec">
		...
		<div class="features">
			<div class="service_div">
				<img class="service_img" src="../Assets/Images/service 1.jpg" alt="haricut" />
			</div>
			<div class="all">
				<div class="service">
					<img src="../Assets/Images/service 2.png" alt="service" width="100px"
						height="100px" />
					<p>Hair Cut</p>
				</div>
				<div class="service">
					<img src="../Assets/Images/service 3.png" alt="service" width="100px"
						height="100px" />
					<p>Shaving</p>
				</div>
				<div class="service">
					<img src="../Assets/Images/service 4.png" alt="service" width="100px"
						height="100px" />
					<p>Beard Trim</p>
				</div>
				<div class="service">
					<img src="../Assets/Images/service 5.png" alt="service" width="100px"
						height="100px" />
					<p>Kid haircut</p>
				</div>
			</div>
	...
	<section>
		<div class="review">
			<h2>Testimonials</h2>
			<p>
				We value our customers' feedback and strive to provide exceptional
				services that leave a lasting impression.<br> Visit our barber
				shop and experience the same level of satisfaction that our
		...
		<div class="fullcard">
			<div class="reviewcard">
				...
				<p>"I can't recommend this barber shop enough! The barbers are
					true professionals who take their time to understand exactly what
					you want."</p>
				<p>John D.</p>
			</div>
			<div class="reviewcard">
				...
				<p>"I've been searching for a barber who can handle my unruly
					beard, and I finally found the perfect place. "</p>
				<p>Michael R.</p>
			</div>
			<div class="reviewcard">
				<div class="flex">
				...
				<p>"Walking into this barber shop is like stepping back in time.
					The vintage decor and old-school charm create a fantastic ambiance.</p>
				<p>Sarah L.</p>
			</div>
	...
	<div class="contact_us_sec">
		...
		<div class="maincontent">
			<div class="con_img_div">
				<img class="big_img" src="../Assets/Images/contact.jpg" alt="haircut image" />
			</div>
				...
				<div class="cont_contact" id="cont_contact">
					...
					<div class="cont_contact__content" id="emailForm">
						...
						<div class="cont_subject_cnt">
							<input type="text" class="cont_subject" id="cont_subject"
								required /> <label for="subject">Subject</label>
						</div>
						<div class="cont_msg_ctn">
							<textarea name="msg" cols="30" rows="4" id="cont_msg"
								class="cont_msg" required></textarea>
							<label for="msg" class="cont_msg_lbl">Message</label>
						</div>
						<button id="send_id" onclick="sende()" class="cont_btn">Send
							Message</button>
					</div>
				</div>
			</div>
		...
		<div class="footer">
			...
			<div class="footicons">
				<a href="#"><img class="footround"
					src="../Assets/Images/Y- facebook.png" alt="What's app" /></a> <a
					href="#"> <img class="footround" src="../Assets/Images/Y- insta.png"
					alt="face book" /></a> <a href="#"> <img
					class="footround" src="../Assets/Images/Y- twitter.png" alt="instagram" /></a>
			...
			<div class="copy_right_div">
				<pre>sharp & clean  <img class="c_round" alt="copy right"
						src="../Assets/Images/C - copyright.png" />  2023</pre>
			</div>
		</div>
	</footer>
</body>
