        ...
        <div>
          <nav class="All-navs">
            <div class="nav_dropdown">
              <button class="nav_dropbtn">Hair styles</button>
              <div class="nav_dropdown-content">
                <a href="barber_medium.jsp">Haircut</a>
                <a href="barber_fade.jsp"
                  >Hair straightening</a
                >
                <a href="barber_long.jsp">Hair coloring</a>
                <a href="barber_undercut.jsp">Facials</a>
                <a href="barber_short.jsp">Shaves</a>
